    ...
    <div class="bg-background px-6 py-20">
        <div class="space-y-16 md:space-y-0 md:grid md:grid-cols-4 md:gap-20 lg:mx-auto lg:max-w-screen-xl">
            ...
            <div class="space-y-10 md:col-span-3">
                ...
                <div class="space-y-10">
                <AboutContent headline="🌎  See the big picture" text="It's easy to lose sight of longterm goals when focusing on the details. I commit to ideas and visions that have a positive impact and always seek to (re)evaluate what’s important for making these ideas become reality."/>
                <Divider />
                </div>
                <div class="space-y-10">
